...
def pred():
    ...
    if 'resume' in request.files:
        ...
        if filename.endswith('.pdf'):
            ...
            return render_template('home.html', message="Invalid file format. Please upload a PDF or TXT file.")
        ...
        return render_template('home.html', predicted_category=predicted_category,recommended_job=recommended_job,
                               phone=phone,name=name,email=email,extracted_skills=extracted_skills,extracted_education=extracted_education)
    else:
        return render_template("home.html", message="No resume file uploaded.")
